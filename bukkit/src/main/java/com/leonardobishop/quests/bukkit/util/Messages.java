...
public enum Messages {
    ...
    TASK_ANTIFARM_HINT_SUBTITLE("titles.task-antifarm.subtitle", "&7Ten postawiony przed chwilą blok się nie liczy"),
    TASK_ANTIFARM_WARNING("messages.task-antifarm-warning", "&c&l⚠ &7Ten blok nie zwiększył postępu zadania &f{task} &7(&f{quest}&7): &e{progress}&7/&f{amount}&7.\n&7Postawiłeś go przed chwilą w tym samym miejscu. Samo stawianie bloków nie cofa postępu."),
