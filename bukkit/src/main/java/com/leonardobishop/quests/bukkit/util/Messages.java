...
public enum Messages {
    ...
    TASK_ANTIFARM_HINT_TITLE("titles.task-antifarm.title", "&e&l⚠ Nie ma tak łatwo"),
    TASK_ANTIFARM_HINT_SUBTITLE("titles.task-antifarm.subtitle", "&7Niszczenie w kółko tego samego bloku się nie liczy"),
    TASK_ANTIFARM_WARNING("messages.task-antifarm-warning", "&c&l⚠ &7Ten blok nie zwiększył postępu zadania &f{task} &7(&f{quest}&7): &e{progress}&7/&f{amount}&7.\n&7Za wiele razy stawiasz i niszczysz ten sam blok na tych samych koordynatach. Samo stawianie bloków nie cofa postępu."),
