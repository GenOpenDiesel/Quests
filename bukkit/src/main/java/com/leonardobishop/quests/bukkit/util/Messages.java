...
public enum Messages {
    ...
    TASK_ANTIFARM_HINT_SUBTITLE("titles.task-antifarm.subtitle", "&7To zadanie trzeba zrobić uczciwie"),
    TASK_ANTIFARM_WARNING("messages.task-antifarm-warning", "&c&l⚠ &7Postęp zadania &f{task} &7(&f{quest}&7) cofa się, bo stawiasz z powrotem to, co kopiesz: &c{progress}&7/&f{amount}&7.\n&7Liczą się tylko bloki &fwykopane&7 — postawienie i ponowne wykopanie tego samego bloku nic nie daje."),
